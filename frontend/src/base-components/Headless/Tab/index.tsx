...
Tab.Button = <C extends React.ElementType = "a">({
  ...
  return (
    <Component
      className={twMerge([
        "cursor-pointer block appearance-none px-5 py-2.5  text-black dark:text-slate-400",
        tab.selected && " dark:text-white",

        // Default
        list.variant == "tabs" && "block ",
        list.variant == "tabs" &&
          tab.selected &&
          "border-t-2 bg-white border-primary border-b-0 border-x-0 text-primary font-medium dark:bg-transparent dark:border-t-darkmode-400 dark:border-b-darkmode-600 dark:border-x-darkmode-400",
        list.variant == "tabs" &&
          !tab.selected &&
          "hover:bg-slate-100 bg-blue dark:hover:bg-darkmode-400 dark:hover:",
