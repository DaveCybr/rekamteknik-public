...
export default function PengeluaranList({ data, tahun, bulan }: Props) {
  ...
  const fetch = async () => {
    ...
    try {
      const response = await axios.get(
        `${Api}/api/laporanBulanan?&bulan=${bulan}&tahun=${tahun}`
      );
                        ...
                        (pengeluaranItem: any, index: number) => {
                          return (
                            <Table.Tr key={index}>
                              ...
                              <Table.Td className="border-r whitespace-nowrap">
