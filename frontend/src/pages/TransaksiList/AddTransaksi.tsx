...
export default function TransaksiAdd({ getResponse }: Props) {
      ...
      >
        <Dialog.Panel>
          ...
          <Dialog.Description className="grid grid-cols-12 gap-4 gap-y-3">
            {/* PELANGGAN */}
            <div className="border rounded-md p-5 col-span-12 shadow-md">
            ...
            <div className="border rounded-md p-5 col-span-12 shadow-md">
              ...
              <div className="mt-3 overflow-x-auto">
                <Table className="w-full shadow-md border-collapse border-gray-200 rounded-lg">
                  ...
                  <Table.Tbody>
                    {keranjang
                      .sort(
                        (a: any, b: any) =>
                          keranjang.indexOf(b) - keranjang.indexOf(a)
                      )
      ...
      >
        <Dialog.Panel>
          ...
          <Dialog.Description className="grid grid-cols-12 gap-4 gap-y-3">
            ...
            <div className="mt-3 col-span-12 overflow-x-auto">
              <Table className="w-full shadow-md border-collapse border-gray-200 rounded-lg">
                <Table.Thead className="rounded-full ">
                  <Table.Tr className="rounded-full bg-primary dark:bg-darkmode-800">
                    {/* <Table.Th className="border-b-0 border-r w-10 text-white text-center first:rounded-tl-md">
